...
module.exports = function(grunt) {
    ...
    grunt.registerMultiTask('inline', "Replaces <link>, <script> and <img> tags to their inline contents", function() {
        ...
        files.forEach(function(filepath) {
            ...
            var destFile = getPathToDestination(filepath, dest, root, saveStructure);
    ...
    function getPathToDestination(pathToSource, pathToDestinationFile, root, saveStructure) {
        ...
        if (saveStructure) {
            var pathWithStructure = pathToSource.replace(root, '').slice(1);
            newPathToDestination = pathToDestinationFile + pathWithStructure;
        }
